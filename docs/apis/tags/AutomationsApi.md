...
[**get_all_actions**](#get_all_actions) | **get** /automations/{automation_id}/actions | Get all actions from given automation
...
# **get_all_actions**
<a name="get_all_actions"></a>
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} get_all_actions()
...
with egoi_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling AutomationsApi->get_all_actions: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_all_actions.ApiResponseFor200) | OK
401 | [ApiResponseFor401](#get_all_actions.ApiResponseFor401) | Unauthorized
403 | [ApiResponseFor403](#get_all_actions.ApiResponseFor403) | Forbidden
408 | [ApiResponseFor408](#get_all_actions.ApiResponseFor408) | Request Timeout
422 | [ApiResponseFor422](#get_all_actions.ApiResponseFor422) | Unprocessable Entity
429 | [ApiResponseFor429](#get_all_actions.ApiResponseFor429) | Too Many Requests
500 | [ApiResponseFor500](#get_all_actions.ApiResponseFor500) | Internal Server Error
503 | [ApiResponseFor503](#get_all_actions.ApiResponseFor503) | Service Unavailable

#### get_all_actions.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Collection of automation actions | 

### Dictionary Keys
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**total_items** | decimal.Decimal, int,  | decimal.Decimal,  | Returned actions count | [optional] 
**[items](#items)** | list, tuple,  | tuple,  | Returned actions | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Returned actions | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**AutomationActions**]({{complexTypePrefix}}AutomationActions.md) | [**AutomationActions**]({{complexTypePrefix}}AutomationActions.md) | [**AutomationActions**]({{complexTypePrefix}}AutomationActions.md) |  | 

#### get_all_actions.ApiResponseFor401
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor401ResponseBodyApplicationJson, ] |  |
...
#### get_all_actions.ApiResponseFor403
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor403ResponseBodyApplicationJson, ] |  |
...
#### get_all_actions.ApiResponseFor408
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor408ResponseBodyApplicationJson, ] |  |
...
#### get_all_actions.ApiResponseFor422
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
#### get_all_actions.ApiResponseFor429
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor429ResponseBodyApplicationJson, ] |  |
...
#### get_all_actions.ApiResponseFor500
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor500ResponseBodyApplicationJson, ] |  |
...
#### get_all_actions.ApiResponseFor503
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor503ResponseBodyApplicationJson, ] |  |
