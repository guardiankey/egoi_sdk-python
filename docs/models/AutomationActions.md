# egoi_api.model.automation_actions.AutomationActions
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Automation actions schema | 
...
**action** | str,  | str,  | Type od action | [optional] 
**parent_id** | [**Id**](Id.md) | [**Id**](Id.md) |  | [optional] 
