...
class ImportContactsWebhookData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["imported", "updated", "ignored", "invalid", "file", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["imported", "updated", "ignored", "invalid", "file", ], str]):
