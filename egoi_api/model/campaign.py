...
class Campaign(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class processed_messages(
                ...
                class MetaOapg:
                    inclusive_minimum = 0
            automation_id = schemas.IntSchema
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["processed_messages"]) -> MetaOapg.properties.processed_messages: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["automation_id"]) -> MetaOapg.properties.automation_id: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "campaign_hash", "status", "thumbnail", "channel", "internal_name", "list_id", "title", "created_by", "group_id", "created", "updated", "start_date", "end_date", "schedule_date", "processed_messages", "automation_id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["processed_messages"]) -> typing.Union[MetaOapg.properties.processed_messages, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["automation_id"]) -> typing.Union[MetaOapg.properties.automation_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "campaign_hash", "status", "thumbnail", "channel", "internal_name", "list_id", "title", "created_by", "group_id", "created", "updated", "start_date", "end_date", "schedule_date", "processed_messages", "automation_id", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        processed_messages: typing.Union[MetaOapg.properties.processed_messages, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        automation_id: typing.Union[MetaOapg.properties.automation_id, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Campaign':
        return super().__new__(
