...
class PushStats(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sends", "opens", "delivered", "received", "bounces", "error", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sends", "opens", "delivered", "received", "bounces", "error", ], str]):
