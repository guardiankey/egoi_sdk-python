...
class OrderProduct(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["product_identifier", "catalog_id", "name", "description", "sku", "upc", "ean", "gtin", "mpn", "link", "image_link", "price", "sale_price", "brand", "quantity", "categories", "related_products", "custom_attributes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["product_identifier", "catalog_id", "name", "description", "sku", "upc", "ean", "gtin", "mpn", "link", "image_link", "price", "sale_price", "brand", "quantity", "categories", "related_products", "custom_attributes", ], str]):
