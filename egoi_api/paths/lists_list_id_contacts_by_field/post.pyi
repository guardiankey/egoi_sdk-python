...
# body param
SchemaForRequestBodyApplicationJson = ContactFieldIdBaseExtraPost


request_body_contact_field_id_base_extra_post = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_contact_by_field_oapg(
        self,
    ...
    def _update_contact_by_field_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_contact_field_id_base_extra_post.serialize(body, content_type)
...
class UpdateContactByField(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_contact_by_field(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def update_contact_by_field(
        ...
        return self._update_contact_by_field_oapg(
            body=body,
