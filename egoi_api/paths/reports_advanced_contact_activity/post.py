...
# body param
SchemaForRequestBodyApplicationJson = GenerateContactActivityReport


request_body_generate_contact_activity_report = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _generate_contact_activity_report_oapg(
        self,
    ...
    def _generate_contact_activity_report_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_generate_contact_activity_report.serialize(body, content_type)
...
class GenerateContactActivityReport(BaseApi):
    ...
    def generate_contact_activity_report(
        ...
        return self._generate_contact_activity_report_oapg(
            body=body,
